...
labels[0:206]=0 #Happy(207)
labels[207:457]=1 #Surprise(249)
labels[458:588]=2 #Anger (135)
labels[589:664]=3 #Fear (75)
labels[664:749]=4 #Sadness (84)

names = ['Happy', 'Surprise', 'Anger', 'Fear', 'Sadness']


def getLabel(id):
    return ['Happy', 'Surprise', 'Anger', 'Fear', 'Sadness'][id]
